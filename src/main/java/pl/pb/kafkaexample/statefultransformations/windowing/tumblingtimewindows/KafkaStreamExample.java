package pl.pb.kafkaexample.statefultransformations.windowing.tumblingtimewindows;
...
import static pl.pb.kafkaexample.statefultransformations.windowing.tumblingtimewindows.KafkaConfig.OUTPUT_TOPIC_1;
...
public class KafkaStreamExample {
	...
	private static void kGroupedTable(final KStream<String, String> source) {
		...
		final Duration gracePeriod = Duration.ofSeconds(1);
		final TimeWindows timeWindows = TimeWindows.ofSizeAndGrace(windowSize, gracePeriod);
