...
import static pl.pb.kafkaexample.statefultransformations.aggregating.reduce_windowed.KafkaConfig.*;
...
public class KafkaStreamExample {
	...
	private static void kGroupedStreamWithTimeWindows(final KStream<String, Long> source) {
	...
	private static void kGroupedStreamWithSlidingWindows(final KStream<String, Long> source) {
	...
	private static void kGroupedStreamWithSessionWindows(final KStream<String, Long> source) {

		/** Aggregating with time-based windowing (here: with an inactivity gap of 100 millis) */
