...
import static pl.pb.kafkaexample.statefultransformations.aggregating.aggregate_windowed.KafkaConfig.getProducerConfig;
...
public class KafkaProducerExample {
	...
	public static void main(final String[] args) {
		...
		final List<String> userTypes = List.of("REGULAR_USER", "ADMIN_USER", "AGENT_USER", "UNKNOWN_USER");
