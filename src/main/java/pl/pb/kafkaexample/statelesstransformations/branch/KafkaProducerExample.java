...
import static pl.pb.kafkaexample.statelesstransformations.branch.KafkaConfig.getProducerConfig;
...
public class KafkaProducerExample {
	...
	public static void main(final String[] args) {
		...
		List.of("REGULAR_USER", "ADMIN_USER", "AGENT_USER", "UNKNOWN_USER").forEach(userType -> {
