...
//		KafkaProtobufSerializer
		// create the producer
		final KafkaProducer<String, Client> producer = getProducer();
	...
	private static void send(final String inputTopic, final KafkaProducer producer, final String key, final Object value) {
