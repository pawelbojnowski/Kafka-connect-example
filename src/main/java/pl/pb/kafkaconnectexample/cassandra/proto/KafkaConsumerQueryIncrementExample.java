...
import static pl.pb.kafkaconnectexample.cassandra.proto.KafkaConfig.CASSANDRA_CONNECTOR_SOURCE_USER_QUERY_INCREMENTING;
...
public class KafkaConsumerQueryIncrementExample {
	...
	public static void main(final String[] args) {
		...
		consumer.subscribe(Arrays.asList(CASSANDRA_CONNECTOR_SOURCE_USER_QUERY_INCREMENTING));
